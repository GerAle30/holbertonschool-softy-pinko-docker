...
Este proyecto demuestra la evolución de una aplicación web desde un contenedor Docker básico hasta una **arquitectura de microservicios escalable horizontalmente** con balanceador de carga. A través de 6 tasks progresivos, construimos una aplicación web completa usando Docker, Docker Compose, Nginx, Flask y técnicas de escalado modernas.
...
### Task 1: Back-end API
```
Docker Container (Flask) → API REST en puerto 5252
```

### Task 2: Front-end + Back-end
```
Front-end Container (Nginx) ←→ Back-end Container (Flask)
      Puerto 9000                    Puerto 5252
```

### Task 3: Comunicación CORS
```
...
### Task 5: Proxy Server
```
Cliente → Proxy (Nginx:80) → Front-end (9000)
                           ↘ Back-end (5252)
```

### Task 6: Escalado Horizontal
```
Cliente → Proxy (Load Balancer) → Back-end-1
                                ↘ Back-end-2
                                ↘ Back-end-N
```
